%% File Name: GS_DeePC_overlapping.m
...
% robustifying DeePC for control of nonlinear systems. 
%
% Sources:
...
% DeePC model when operating over a wide range of conditions. Overlapping
% operating regions are introduced to ensure smooth transitions between
% local predictors and to avoid performance degradation or infeasibility
...
T_d = size(overlapping_regions(1).H_u,2)+L-1;
fprintf('\n=== Overlapping HANKEL MATRIX CONSTRUCTION COMPLETE ===\n');
